...
import { Settings as SettingsIcon, Shield, User, Sliders, Bell, Save, RotateCcw } from 'lucide-react';
...
type SettingsTab = 'general' | 'security' | 'preferences' | 'anonymization' | 'notifications';
...
const Settings: React.FC = () => {
  ...
  const renderTabContent = () => {
    switch (activeTab) {
      ...
      case 'anonymization':
        return <AnonymizationSettings onSettingsChange={() => setHasChanges(true)} />;
      case 'notifications':
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">Gestiona las configuraciones y preferencias del sistema de anonimización</p>
            </div>
          </div>
          ...
          {hasChanges && (
            <div className="flex items-center gap-4 p-4 bg-amber-50 border border-amber-200 rounded-lg">
              <div className="flex-1">
                ...
                <p className="text-amber-600 text-sm">Recuerda guardar tus cambios antes de salir</p>
              </div>
