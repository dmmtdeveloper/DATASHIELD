    ...
    <div className="p-6">
      ...
      <div className="card">
        ...
        <div className="flex justify-between mt-6">
          <button 
            className={`flex items-center gap-2 px-6 py-2 text-white bg-gray-400 border rounded-lg hover:bg-gray-600 disabled:opacity-50 disabled:cursor-not-allowed ${
